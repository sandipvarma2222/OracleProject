--1. log in as system and create a user called c##bank and set password of the user to bank

create user c##bank identified by bank;

--2. grant relevant permissions to create objects to the user c##bank

grant create session,create table,create view,create procedure,create synonym,create trigger,unlimited tablespace to c##bank;

--3. connect to the user c##bank and create the required tables for the bank project
...
-- INSERT DATA INTO THE BANK_CUST_CONTACT TABLE
...
-- INSERT DATA INTO THE BANK_EMPLOYEE  TABLE
...
-- INSERT DATA INTO THE BANK_INT_RATE TABLE
...
-- INSERT DATA INTO THE BANK_FD_ACCOUNT TABLE
...
-- INSERT DATA INTO THE BANK_RD_ACCOUNT TABLE
...
-- INSERT DATA INTO THE BANK_SB_ACCOUNT TABLE
...
-- INSERT DATA INTO THE BANK_TRANSACTION TABLE
